...
class WeldViewerApp(tk.Tk):
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    _SETTINGS_FILE = r"C:\WeldDetectoSetup.par"
    _SETTINGS_DEFAULTS = {
        "plc_ip":       "172.28.2.1",
        "plc_db":       "28160",
        "plc_rack":     "0",
    ...
    def _save_settings_dict(self, s: dict):
        ...
        try:
            ...
            try: self.app_log(f"Impostazioni non salvate ({self._SETTINGS_FILE}): {e}", "warn")
            except Exception: pass  # app_log non ancora disponibile all'avvio

    def _save_settings(self):
        self._save_settings_dict(self._settings)

    def _open_settings(self):
        dlg = tk.Toplevel(self)
        dlg.title("Impostazioni  --  WeldDetecto v50")
        ...
        _row(plc_lf, "DB number:", "plc_db",   8,  tip="es. 28160")
        ...
        def _save():
            ...
            for attr, key in [('_pv_plc_ip','plc_ip'),('_pv_plc_db','plc_db'),
            ...
            if sqp:
                for attr in ['_pv_sim_src_sql_path','_pv_stat_sql_path',
                    ...
                    if sv2: sv2.set(sqp)
            self._save_settings()
            self.app_log("Impostazioni salvate in " + self._SETTINGS_FILE, "ok")
            dlg.destroy()
        ...
        ttk.Label(dlg, text="File: " + self._SETTINGS_FILE,
    ...
    def _build_plc_autoexport(self, parent):
        ...
        self._pv_autoexp_sql_path = tk.StringVar(
            value=self._pv_global_sql_path.get() or os.path.join(os.path.expanduser("~"), "WeldExport", "weld_archive.sqlite"))
