...
class WeldViewerApp(tk.Tk):
    ...
    def _build_stat_tab(self, parent):
        ...
        SWEEP_DEFS = [
            ...
            ("adapt_baseline_enable",  "AdaptBL En",      "0",    "0",  "1",   "2",  True ),
            ("adapt_baseline_offset",  "AdaptBL Off[mm]", "3.0",  "1.0","4.0", "4",  False),
        ...
        PARAM_LABELS = {
            ...
            "adapt_baseline_enable":  "AdaptBL",
            "adapt_baseline_offset":  "AdaptOff",
        ...
        PARAM_COLORS = {
            ...
            "adapt_baseline_enable":  "#d29922",
            "adapt_baseline_offset":  "#d2a84f",
